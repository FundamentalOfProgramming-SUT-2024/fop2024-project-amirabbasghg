...
void jadid_map(char map[MAP_ROWS][MAP_COLS], Room rooms[], int *room_count , int *m) {
...
void check_and_move(int *playerRow, int *playerCol, char map[MAP_ROWS][MAP_COLS], Room rooms[], int *room_count , int *m, int *tedadtabaghe) {
    if (map[*playerRow][*playerCol] == '&') {
        ...
        (*tedadtabaghe)++;
        jadid_map(map, rooms, room_count , m);
    ...
    g+=a+20;
        homes[m].g=g;
         ...
         playerCol++;
                ...
                check_and_move(&playerRow, &playerCol, map, rooms, &room_count , &m , &tedadtabaghe);
